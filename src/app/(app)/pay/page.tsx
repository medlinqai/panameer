...
/**
 * Pay Providers — a titled placeholder the requester rail can land on (WS-A).
 *
 ...
 */
export const metadata = { title: "Pay Providers · Panameer" };

export default async function Page() {
  await guardPage("canHireTalent");
  return <ComingSoon title="Pay Providers" />;
}
