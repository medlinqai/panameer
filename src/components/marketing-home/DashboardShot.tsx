  ...
  return (
    <svg className="viz" viewBox="0 0 300 60" role="img"
      ...
      <line x1={(w * peers) / 100} y1="12" x2={(w * peers) / 100} y2="38"
        stroke="#272334" strokeWidth="2.5" strokeLinecap="round" />
      <text x="0" y="12" fontSize="10.5" fontWeight="700" fill="#272334">You {you}</text>
      <text x={(w * peers) / 100} y="52" fontSize="10.5" fontWeight="700" fill="#272334"
